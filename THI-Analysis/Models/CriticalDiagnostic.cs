...
namespace THI_Analysis.Models
{
    ...
    public partial class CriticalDiagnostic
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CriticalDiagnostic()
        {
            this.THI_AnalysisFeedback = new HashSet<THI_AnalysisFeedback>();
        }
    
        public int CriticalDiagnosticKey { get; set; }
        public string CriticalDiagnosticsDescription { get; set; }
