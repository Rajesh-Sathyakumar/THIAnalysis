...
namespace THI_Analysis.Models
{
    ...
    public partial class MemberSupportTicket
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public MemberSupportTicket()
        {
            this.THI_AnalysisFeedback = new HashSet<THI_AnalysisFeedback>();
        }
    
        public int MemberSupportTicketsKey { get; set; }
        public string MemberSupportTicketsDescription { get; set; }
